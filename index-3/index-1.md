...
데이터에 대한 더 많은 정보는 [Download](../index-2/undefined/index-3.md) tutorial을 읽어 보세요.
...
[TensorBoard](index-2.md)에서 사용된 이벤트 파일을 내보내기 위해서, 그래프 작성 단계에서 모든 요약자료를 \(이 경우에는 하나\) 하나의 op에 모아야 한다.
...
**주의**: 어떻게 Tensorboard를 만들고 실행하는지에 대한 더 많은 정보는, 동봉된 튜토리얼을 보시기 바랍니다. [Tensorboard: 학습을 시각화하기](index-2.md).
